...
export const AuthWrapper = ({ title, subheader, children, showFooter=true }: AuthWrapperProps) => {
  ...
  const isSignUpPage = path === "/register";
  const isSignInPage = path === "/login";
